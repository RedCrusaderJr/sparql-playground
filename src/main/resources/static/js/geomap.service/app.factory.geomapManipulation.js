	...
	*/
	...
	function geomapManipulationFactory($http, config) {
		...
		function createMap(latitude, longitude, zoom) {
			...
			L.tileLayer('https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token=pk.eyJ1IjoicmVkLWNydXNhZGVyLWpyIiwiYSI6ImNsZnBtN2VyaTEzcGMzc21oYWNjdWVyN3IifQ.T8CH5fJOOUPS4AQr7-rbaA', {
				maxZoom: 18,
