...
public class Case1NoWarmUp1CIMXML {
	...
	public void test1Basic() throws Exception {
		this.currentTestName = "Case1NoWarmUp1CIMXML-test1Basic";
	...
	public void test2DrawFeeder() throws Exception {
		this.currentTestName = "Case1NoWarmUp1CIMXML-test2DrawFeeder";
	...
	public void test3DrawFeederOpt() throws Exception {
		this.currentTestName = "Case1NoWarmUp1CIMXML-test3DrawFeederOpt";
	...
	public void test4DrawBuffer() throws Exception {
		this.currentTestName = "Case1NoWarmUp1CIMXML-test4DrawBuffer";
	...
	public void test5DrawBuffertOpt() throws Exception {
		this.currentTestName = "Case1NoWarmUp1CIMXML-test5DrawBuffertOpt";
	...
	public void test6DrawHealthy() throws Exception {
		this.currentTestName = "Case1NoWarmUp1CIMXML-test6DrawHealthy";
	...
	public void test7DrawHealthyOpt() throws Exception {
		this.currentTestName = "Case1NoWarmUp1CIMXML-test7DrawHealthyOpt";
	...
	public void test8DrawAffected() throws Exception {
		this.currentTestName = "Case1NoWarmUp1CIMXML-test8DrawAffected";
	...
	public void test9DrawAffectedOpt() throws Exception {
		this.currentTestName = "Case1NoWarmUp1CIMXML-test9DrawAffectedOpt";
	...
	public void test10DrawHazard() throws Exception {
		this.currentTestName = "Case1NoWarmUp1CIMXML-test10DrawHazard";
